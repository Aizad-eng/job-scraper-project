...
export const FIELD_HINTS = {
    ...
    cleanTitles: 'Adds jobTitleClean to every row: the role as you would write it in an email ("Director of Sales" from "Director of Sales - Memphis"). Rules handle most titles; Claude Haiku polishes the odd ones, remembered per title.',
